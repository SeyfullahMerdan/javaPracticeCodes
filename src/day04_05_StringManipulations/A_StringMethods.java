...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        int index = text.indexOf("o"); // int degiþkenine atanabilir. küçük 'o' harfi
         ...
         *  indexOf un sondan olan hali fakat index numaralarý degiþmez.
         */

        System.out.println("sondaki n harfinin index >>>> " + cicek.lastIndexOf('n'));  //8
        System.out.println("----------");
        String textt = "halukbilgin";
        System.out.println("En sondaki i nin indexi = " + textt.lastIndexOf("i")); //9
        System.out.println("ilk baþtan i nin indexi = " + textt.indexOf("i")); //6    textt.indexOf!=textt.lastIndexOf == harf birden fazla kullanýlmýþ
        System.out.println("----------");
        ...
        /** ReplaceFirst
        * Replace ile ayný sadece ilk bulunaný degiþtirir
         */
        String txt = "Merhaba Dunya";

        System.out.println("orjinal hali = " + txt); //orjinal hali = Merhaba Dunya
        
        System.out.println("butun a larýn degistigi hali = " + txt.replace("a", "e"));
        // butun a larýn degistigi hali = Merhebe Dunye
